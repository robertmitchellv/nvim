return {
  ...
  opts = function()
    ...
    ins_left({
      ...
      diff_color = {
        added = {
          fg = colors.lualine.add_fg,
          bg = colors.lualine.add_bg,
        },
        modified = {
          fg = colors.lualine.change_fg,
          bg = colors.lualine.change_bg,
        },
        removed = {
          fg = colors.lualine.delete_fg,
          bg = colors.lualine.delete_bg,
        },
      },
